...
<div id="carouselExample" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="image/hand.jpg" class="d-block w-100" alt="Slide 1" height="500">
    </div>
    <div class="carousel-item">
      <img src="image/bank.jpg" class="d-block w-100" alt="Slide 2" height="500">
    </div>
  </div>
...
<div class="row">
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded" src="image\blood_drop_logo.jpg" alt="" style="width:60%;height:300px;" >
            </div>
        </div>
        <hr>
        <div class="row">
...
<br>
        ...
        <div class="row mb-4">
          ...
          <p> <a class="btn btn-lg btn-secondary btn-block" href="main.html" style="align:center; background-color:#7FB3D5;color:#273746 ">Restart page </a></p>
